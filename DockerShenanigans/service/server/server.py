...
idTypeDict = ["Native", "XML", "JSON", "GoogleProtoBuff", "ApacheAvro", "YAML", "MessagePack", "all"]
typeIdDict = {"Native": 0, "XML": 1, "JSON": 2, "GoogleProtoBuff": 3, "ApacheAvro": 4, "YAML": 5, "MessagePack": 6, "all": -1}
services = []
commands = {}
